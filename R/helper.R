...
#' @param cuisearch.feature A vector of NLP features related to the target code. Can be generated by ONCE (CUIsearch). If \code{NULL}, then use all features in \code{input.cov}.
